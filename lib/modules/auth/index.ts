...
export type UserListenerFn = (user?: User) => void;
...
export default class Auth extends ModuleBase {
   ...
   * @param listener
   */
  onAuthStateChanged(listener: UserListenerFn) {
   ...
   * @param listener
   */
  onIdTokenChanged(listener: UserListenerFn) {
   ...
   * @param listener
   */
  onUserChanged(listener: UserListenerFn) {
